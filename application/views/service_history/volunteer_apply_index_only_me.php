...
<div class="col-xs-12">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">志工報名-個人報名狀況</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
            <div style="padding-left: calc((100% - 1134px) / 2);padding-right: calc((100% - 1134px) / 2);">
                <div class="row" style="margin-bottom: 10px;">
                    <div class="col-md-4" style="text-align: left">
                        <a href="<?php echo base_url('/volunteer_apply/only_me/'.strtotime(($week_list[3]).'-4 day')) ?>"><button>《上一週</button></a>
                    </div>                
                    <div class="col-md-4">
                        
                    </div>                
                    <div class="col-md-4" style="text-align: right">
                        <a href="<?php echo base_url('/volunteer_apply/only_me/'.strtotime(($week_list[3]).'+4 day')) ?>"><button>下一週》</button></a>
                    </div>                
                </div>
                                        ...
                                        if(date('m',strtotime($date))==$SHOW_MONTH)
                                        {
                                            ...
                                            if(!empty($calendar_list[$vc_data->vcID][$date]))
                                            {
                                                ...
                                                foreach ($calendar_list[$vc_data->vcID][$date] as $type => $calendar_data)
                                                {
                                                    ...
                                                    if($calendar_data->num_got_it+$calendar_data->num_waiting <= $applied_count)
                                                        $button_str = null;
