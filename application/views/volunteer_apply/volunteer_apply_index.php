...
<div class="col-xs-12">
    <div class="box">
        <div class="box-header">
            ...
            查詢起迄：<input type="text" class="datepicker" name="start_date" id="start_date"> 至 <input type="text" class="datepicker" name="end_date" id="end_date"> <button type="button" onclick="search_range()">查詢</button><br>
                                        ...
                                        if($SHOW)
                                        {
                                            ...
                                            if(!empty($calendar_list[$vc_data->vcID][$date]))
                                            {
                                                ...
                                                foreach ($calendar_list[$vc_data->vcID][$date] as $type => $calendar_data)
                                                {
                                                    ...
                                                    $long_range_class = $calendar_data->long_range?'long_range':null; // 2019 05 06 鵬 加上此列
                                                    $tmp_str = '
...
<script>
    ...
    function search_range(){
        ...
        if (!isNaN(unixtime_end) && !isNaN(unixtime_start)){
