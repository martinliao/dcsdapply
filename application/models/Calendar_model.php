...
class Calendar_model extends MY_Model{
  ...
  public function __construct()
  {
    ...
    public function insert_self_evaluation($mode, $year, $helf, $category, $top_grade, $bottom_grade, $uid){
    ...
    public function update_self_evaluation($mode, $year, $helf, $category, $top_grade, $bottom_grade, $uid){
        $this->db->set('status', $mode);
        $this->db->set('top_grade', $top_grade);
        $this->db->set('bottom_grade', $bottom_grade);
        $this->db->set('modify_time', date('Y-m-d H:i:s'));
